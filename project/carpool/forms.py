...
class EditRideForm(forms.ModelForm):
    ...
    def save(self, ride):
        ...
        departure, _created = Location.objects.get_or_create(
        ...
        arrival, _created = Location.objects.get_or_create(
        ...
        for index, so_form in enumerate(self.stopovers.cleaned_data):
            so_location, _created = Location.objects.get_or_create(
                fulltext=so_form["fulltext"],
                street=so_form["street"],
                zipcode=so_form["zipcode"],
                city=so_form["city"],
                lat=so_form["latitude"],
                lng=so_form["longitude"],
            )
